...
public class LogUtils {
    //默认的TAG，建议后面加下划线
    private static final String DEFAULT_TAG = "Song_";

    //日志等级（不想打印日志，可设置为 log.ASSERT）
    public static int LOG_LEVEL = Log.VERBOSE;
//    public static int LOG_LEVEL = Log.ASSERT;
...
//            Log.e(tag, "(" + targetStackTraceElement.getFileName() + ":" + targetStackTraceElement.getLineNumber() + ")");
    ...
    private static StackTraceElement getTargetStackTraceElement() {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            boolean isLogMethod = stackTraceElement.getClassName().equals(LogUtils.class.getName()) || stackTraceElement.getClassName().startsWith("java.lang");
